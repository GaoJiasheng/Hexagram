...
export const BOOKS = [
  ...
  // 佛扩 Wave 6c:维摩诘所说经(罗什译),14 品分卷上中下,子页 維摩詰所說經/01…14(数字子页),
  // chapterTitles 映品名;各品首行卷题「维摩诘所说经卷X」、译者题、品题「X品第N」非正文,dropParaRe 剔。
  {
    slug: 'weimojie', title: '维摩诘经',
    pages: ['維摩詰所說經/01', '維摩詰所說經/02', '維摩詰所說經/03', '維摩詰所說經/04', '維摩詰所說經/05', '維摩詰所說經/06', '維摩詰所說經/07', '維摩詰所說經/08', '維摩詰所說經/09', '維摩詰所說經/10', '維摩詰所說經/11', '維摩詰所說經/12', '維摩詰所說經/13', '維摩詰所說經/14'],
    chapterTitles: ['佛国品', '方便品', '弟子品', '菩萨品', '文殊师利问疾品', '不思议品', '观众生品', '佛道品', '入不二法门品', '香积佛品', '菩萨行品', '见阿閦佛品', '法供养品', '嘱累品'],
    dropParaRe: '^(维摩诘所说经卷[上中下]|姚秦三藏鸠摩罗什译|.{2,7}品第[一二三四五六七八九十]+)$',
    exactChapters: 14,
  },
]
