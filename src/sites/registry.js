...
export const SITES = [
  ...
  // ── 诗词曲三组(二十四期)。十一组皆经、子,此三组属集部,故各自独立成组、互不相链。
  //    印名按朝代取(观唐/观宋/观元)——诗词曲本以时代分(一代有一代之文学),
  //    比按体裁取的「观诗」更无歧义(「观诗」易与已在儒典里的《诗经》混淆)。
  {
    key: 'tangshi',
    group: 'tangshi',
    brand: '观唐',
    portalTitle: '唐诗研读',
    portalDesc: '',            // 留空:由 MasterPortalPage 从 texts.json 派生(加书自动更新)
    home: '/tangshi',
    prefix: '/tangshi',
    accent: 'tangshi',
    switchLabel: '唐',
    hasSearch: true,
    nav: [{ to: '/tangshi', label: '经典' }],
    mobileNav: [{ to: '/tangshi', label: '经典', icon: '☷', exact: false }],
    mobileSwitch: false,
  },
  {
    key: 'songci',
    ...
    switchLabel: '宋',
    hasSearch: true,
    nav: [{ to: '/songci', label: '经典' }],
    mobileNav: [{ to: '/songci', label: '经典', icon: '☷', exact: false }],
    mobileSwitch: false,
  },
  {
    key: 'yuanqu',
