...
export function getDivinationResult(hexagram, movingLines, hexagramByBinary) {
  ...
  if (n === 0) {
    return {
      ...
      primaryTexts: [{ label: hexagram.name + '·卦辞', text: hexagram.judgment }],
  ...
  if (n === 1) {
    ...
    return {
      ...
      primaryTexts: [
        { label: hexagram.name + '·' + line.title, text: { original: line.original, translation: line.translation } },
      ],
      secondaryTexts: [
        { label: hexagram.name + '·卦辞', text: hexagram.judgment, collapsible: true },
        ...(bianHex ? [{ label: bianHex.name + '·卦辞', text: bianHex.judgment, collapsible: true }] : []),
      ],
      bianHex,
    }
  }
  ...
  if (n === 3) {
    return {
      ...
      primaryTexts: [
        { label: hexagram.name + '（贞）·卦辞', text: hexagram.judgment },
        ...(bianHex ? [{ label: bianHex.name + '（悔）·卦辞', text: bianHex.judgment }] : []),
      ],
      secondaryTexts: [],
      bianHex,
    }
  ...
  if (n === 4) {
    ...
    const result = {
      ...
      primaryTexts: [],
      secondaryTexts: [
        { label: hexagram.name + '（本卦）·卦辞', text: hexagram.judgment, collapsible: true },
      ],
      bianHex,
    }
    if (bianHex) {
  ...
  if (hexagram.id === 1 && hexagram.extra?.use) {
    return {
      ...
      secondaryTexts: [{ label: '乾·卦辞', text: hexagram.judgment, collapsible: true }],
      bianHex,
    }
  }
  if (hexagram.id === 2 && hexagram.extra?.use) {
    return {
      ...
      secondaryTexts: [{ label: '坤·卦辞', text: hexagram.judgment, collapsible: true }],
      bianHex,
    }
  }
  return {
    ...
    primaryTexts: bianHex ? [{ label: bianHex.name + '·卦辞', text: bianHex.judgment }] : [],
    secondaryTexts: [{ label: hexagram.name + '（本卦）·卦辞', text: hexagram.judgment, collapsible: true }],
    bianHex,
  }
}
