...
function isNeutralPath(p) {
  return p === '/' || p === MASTER_PORTAL_PATH || p === '/concepts' || p === '/timeline' || p === '/mingju' || p === '/privacy' || p === '/ba' || p === '/legal' || p === '/admin/stats' || p === '/debates' || p.startsWith('/debates/') || p === '/zhuzi' || p === '/books' || p.startsWith('/books/')
}
