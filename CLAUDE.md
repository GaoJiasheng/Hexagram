...
- [x] 中医典籍组(已发 v1.23.0,第九组)——独立组 zhongyi(观和/杏林赭),守 v19 §0「**研习不诊疗**」铁律(首页+各书小传「⚠ 非医疗建议」声明;本草经「主治…」、伤寒论方剂属原典照译,但注疏/延伸不述功效用法用量、不下病症/疗效断语、不教自疗)。**四书全译注延**:素问 15 篇(卷分组 `pickHeadings` 跨卷选核心篇,异体页名 欬論/痺論 按页字配)676 段、灵枢 8 篇 192 段、伤寒论 22 篇(单页 splitHeadings)984 段、神农本草经 18 类(6 部×3 品)359 药;并发 workflow 85 单元/170 代理/9.4M token,~3357 锚注、63 篇延伸全覆盖。`gen-zhuzi-wf` 加 `TIELU_YI` + 分书 styleRule(内经问答体/伤寒方剂只录名/本草主治照译诠释守铁律)+ 按 corpus 过滤生成。**改中医内容守研习不诊疗铁律,逐批 check-data 过才 commit。** 另:**docs/design-v20 谋略杂纂**(《天下无谋》维基有原文的 5 部:罗织经/小人经/权谋术/韬晦术/止学,owner 定收并显著框注「托名·疑现代伪作」、批判延伸不作权术教程)待开工
