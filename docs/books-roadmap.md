...
**截至最后更新(见文末),已收录 112 本**,其中 2026-07 完成的**社会学 14 本**成规模:社会学的想象力 / 新教伦理与资本主义精神 / 自杀论 / 日常生活中的自我呈现 / 独自打保龄 / 论美国的民主 / 社会分工论 / 孤独的人群 / 街角社会 / 菊与刀 / 流动的现代性 / 黑人的灵魂 / 规训与惩罚 / 社会理论与社会结构;随后 §1 三簇 14 本也已收官(见下)。

---

## 1. 已收官:三簇 14 本(2026-07,双并发 × 7 批产出)

以下三簇(原「待做书单」)**已全部完成**,下表仅作存档,不再是待办:

| slug | 书 | 作者 | 簇 |
|---|---|---|---|
| `xiangtu-zhongguo` | 乡土中国 | 费孝通 | A 人类学 |
| `youyu-de-redai` | 忧郁的热带 | 列维-斯特劳斯 | A 人类学 |
| `wenhua-de-jieshi` | 文化的解释 | 克利福德·格尔茨 | A 人类学 |
| `liwu` | 礼物 | 马塞尔·莫斯 | A 人类学 |
| `jiejing-yu-weixian` | 洁净与危险 | 玛丽·道格拉斯 | A 人类学 |
| `guojia-weishenme-shibai` | 国家为什么会失败 | 阿西莫格鲁 & 罗宾逊 | B 补薄标签(政治/经济) |
| `jiyin-zhuan` | 基因传 | 悉达多·穆克吉 | B 补薄标签(科学) |
| `zhengyi-lun` | 正义论 | 约翰·罗尔斯 | B 补薄标签(哲学/政治) |
| `xixifu-shenhua` | 西西弗神话 | 加缪 | B 补薄标签(哲学/文学) |
| `daode-de-puxi` | 道德的谱系 | 尼采 | C 尼采续补 |
| `chalatusitela-rushishuo` | 查拉图斯特拉如是说 | 尼采 | C 尼采续补 |
| `beiju-de-dansheng` | 悲剧的诞生 | 尼采 | C 尼采续补 |
| `kuaile-de-kexue` | 快乐的科学 | 尼采 | C 尼采续补 |
| `ouxiang-de-huanghun` | 偶像的黄昏 | 尼采 | C 尼采续补 |

**产出法**:双并发 Agent(每批 2 本,共 7 批),`model: opus`,每批完成后主会话独立核验(JSON 合法/字数区间/引文条数与长度/`fill=var`/弯引号/mindmap ref 覆盖/build/浏览器封面走查)才合并提交,不采信 agent 自报。**新教训**:并发 agent 偶发因网络中断或撞会话额度上限(`session limit`)中途失败——处理方式是查现场留下了什么(封面母题/mindmap/overview 常常已经做完一部分)、只续写缺的部分,不整个推倒重来;若确认一点没写(目录不存在)才完全重跑。尼采 5 本因涉及「超人/权力意志/上帝已死」等历史上被严重曲解盗用的概念,每本都按 §2 加了强制批判性框注(专章讲编辑史与常见误读),后写的书对前面已讲过的概念(如"上帝已死"在《查拉图斯特拉》讲过后,《快乐的科学》只需简述+导流,不重复完整论证)。

## 1b. 曾经的「待做书单」原文(存档,已全部完成,勿再当 TODO 用)
...
### 簇 C · 尼采(观书已有《善恶的彼岸》,以下为续补)

现只有 1 本尼采(`shane-de-bian` 善恶的彼岸)。续补优先级:

| slug 建议 | 书 | 备注 |
|---|---|---|
| `daode-de-puxi` | 道德的谱系 | **首推**:尼采最系统、最像论证的一本(主人/奴隶道德、怨恨 ressentiment、禁欲主义理想);他自称是《善恶的彼岸》的「补充与澄清」,**与已有那本即刻成对**,也最适合「一篇读懂」格式 |
| `chalatusitela-rushishuo` | 查拉图斯特拉如是说 | 旗舰、最著名(上帝已死/超人/永恒轮回),但**散文诗/寓言体、几乎无线性章节**,写时须**按主题重组、不逐节复述**,难度更高 |
| `beiju-de-dansheng` | 悲剧的诞生 | 处女作,「日神/酒神」源头,谈艺术与希腊悲剧;接站内叔本华《作为意志和表象的世界》 |
| `kuaile-de-kexue` | 快乐的科学 | 次选:「上帝已死」那则「疯子」寓言出处,格言体 |
| `ouxiang-de-huanghun` | 偶像的黄昏 | 次选:晚期、短小凌厉,可当晚期尼采速览 |

> owner 未定序时的默认打头:**《道德的谱系》+《查拉图斯特拉如是说》**双并发(结构最清 + 分量最重)。slug/accent/motif 均**未预置**,需按 §3 新建母题。
>
> **尼采是全哲学史最易被读歪、被盗用的作者**——「超人」「权力意志」曾被纳粹经其妹编辑篡改利用,「上帝已死」常被误读成得意的无神论宣言(实为对文化危机的**诊断与忧虑**)。任何一本尼采都**必须照 §2 加重批判性框注**,专门拆这些误读。
>
> ⚠️ **《权力意志》不要当尼采著作单独收**——那不是他写成出版的书,而是他妹妹(有纳粹倾向)从笔记残稿拼编、编辑塑形的合集,地位争议极大;真要做须配最强框注说明来历。
...
**簇 A 里费孝通、莫斯、道格拉斯无此风险,可正常写**;忧郁的热带、以及任何涉及殖民/异文化凝视的,酌情加。**簇 C 尼采全部要加**(拆「超人/权力意志/上帝已死」的纳粹盗用与无神论误读)。已落地范例:`src/data/books/ju-yu-dao/`(菊与刀)、`heiren-de-linghun/`(黑人的灵魂)。
...
_最后更新:2026-07-27(簇 A 人类学 5 本 + 簇 B 补薄 4 本 + 簇 C 尼采续补 5 本共 14 本全部完成,双并发 7 批产出,观书共 112 本)。下一批待 owner 圈定新簇。更新本文时请同步「已收录 N 本」与完成清单,但真相永远以 `index.json` 为准。_
