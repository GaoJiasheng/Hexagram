...
> 最后通盘整理:**2026-08-05**(白话进度随时在变,数字以 §0 脚本为准)。
...
**2026-08-05 快照**:典籍 **70 部** · 白话 **1642 章**· 观书 **140 本 1371 篇**(富文本 1270)·
争鸣 **88 辩** · 书级导读 **65 篇**(全齐)· 家级导读 **13 篇**(全齐)· 名句集 746 句 ·
iOS **build 50** / 版本 **1.32.0 正在等待审核** · 生产 `hexa.gavin.pub`(Cloudflare Pages)。

> 脚本会报三本「无白话」,**性质完全不同,别混**:
> · `zhongyi/nanjing`(81章)—— **owner 定的不做**,不是缺口
> · `songci/songci300`(283章)、`yuanqu/yuanqu`(72章)—— **是真缺口**,未开工(见 §2.2)
> 唐诗不在这张名单上是因为已开工(**305/320**),脚本只判「文件在不在」不判满没满。
...
| 白话 | **1642 章** | **0 坏引文**,每章有图。**唯一未满的是诗词曲**,见 §2.2 |
| 书级导读「前世今生」 | **65 / 65** | ✅ 全齐 |
...
| 书级导读 | ✅ | ✅ | ✅ |
| 家级导读 | ✅ | ✅ | ✅ |
| **白话深读** | ⏳ **305/320** —— 卷 1/2/3/4/5/6 **六卷全满**,只剩卷7 七绝 36/51 | ⏳ **0/283** | ⏳ **0/72** |
...
- [ ] **④ 每首白话深读** —— **唐诗 305/320 · 宋词 0/283 · 元曲 0/72(共 675 首,已成 305)**。
      唐诗**六卷已满**(五古35 · 七古28 · 乐府44 · 五律80 · 七律53 · 五绝29),
      **只剩卷7 七绝 36/51 —— 缺 26–34、46–51 共 15 首**,补完唐诗即收官。
      之后是宋词 283、元曲 72,两组尚未开工。
      粒度:唐诗走「组-序」细粒度键(同诗经),宋词元曲走纯章号。
      **owner 2026-08-05 定的体例:2000–4000 字、按名气浮动(名篇多写、无名的短写)、3–4 图**,
      要讲六件事:创作背景 / 诗人生平(只给与这首相关的那段)/ 这首的场景故事(传说标「相传」)/
      影响(后人化用、进了哪些选本)/ 主旨展开 / 深度解析(炼字对仗章法声律)。
      ⛔「主旨展开」是讲这首在说什么,**不是讲它教我们什么**。
