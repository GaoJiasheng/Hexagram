...
争鸣 84 辩 · 书级导读 62 篇 · **家级导读 10 篇生产中(§2.1,基建已就位)** ·
...
## 2.1 家级导读「一家之来路」⬅ **10 篇并发生产中(2026-08-02)**

**SOP 已写好:[school-intro-standard.md](./school-intro-standard.md) —— 动手前必读。**
数据 `src/data/<corpus>/school.json`,一组一篇,挂组首页展开式入口。

**唯一的题目是「书与书之间」**:读者读完《论语》《孟子》《荀子》《近思录》四篇书导读,
仍没人告诉他这四本什么关系——孔孟荀怎么分岔、汉儒宋儒为什么读出两副面孔、
近思录凭什么成了理学阶梯。**写成书级的重复就是废品**(62 篇书导读已把各书自己的来路写透)。

| 类 | 组 | 怎么写 |
|---|---|---|
| **A 真流派** | 儒 · 道 · 墨 · 法 · 纵横 | 直接按「家」写;谱系有站内一手材料坐实(《天下》《显学》《非十二子》) |
| **B 体裁不同** | 佛 · 心学 | 佛是外来传入,写「译经史→判教→宗派」,译典与中土撰述分两段;心学是**儒门内部转折**,与儒篇明确交棒 |
| **C 不成「家」** | 兵 · 中医 · 谋略 | **题目必须换**:兵→「这七本怎么被编成一套」· 中医→「医经与经方两系」· 谋略→**「这个类目是怎么被编出来的」** |

> ⛔ **谋略绝不能写成「谋略家这一流派」** —— 9 本里 5 本是托名伪书,写成流派史等于给伪书追认谱系。
> ➖ **易经不做** —— 那一层已齐(学堂 11 篇 · 源流页 · 人物志 10 家 · 筮例 · 史事 · 名词表)。

**顺序**:owner 2026-08-02 拍板**十组一次并发做完、一律加厚版**(原「墨家样板先验收」的分批作废)。
**厚度(加厚档)**:儒/道 11000–13000 · 佛 10000–12000 · 法兵医谋 9000–11000 · 墨/纵横/心学 8000–10000。
加厚不是注水——多出的篇幅用在**转折点的来龙去脉**,不许把书级导读重抄一遍。

**基建已就位(2026-08-02,内容落地即可见)**:
`src/features/reader/school.js` 懒加载 + `SchoolEntry.jsx`(挂组首页书架之上,抽屉 → ⤢ 整页)
+ `SchoolPage.jsx` + 10 条 `/<组>/school` 路由 + `build-content-assets` 出
`public/content/school/<corpus>.json` 分片 + **check-data `school` 段校验**
(h2 ≥5 · pull ≤1 · **禁 callout/list/steps** · 字数分档 · 图表 ≥4 · 引文逐字校)。

## 2.2 观书 · 下一批 14 本(owner 2026-08-02 已定,可直接开工)

现 **112 本**。[books-roadmap.md](./books-roadmap.md) 的三簇 14 本(人类学/补薄标签/尼采)已收官,
下面这批是**照当前 112 本量出来的空档**选的,不是凭印象:

> 文学 8 本里 5 本是反乌托邦或尼采,真正的小说只有《百年孤独》——**19 世纪小说 0、中国现代文学 0**;
> 科学 6 本里**演化论本尊 0、数学 0、复杂系统 0**;环境 1 本;历史 11 本里世界史几乎只靠两本通史;
> **性别 0 · 技术思想史 0 · 战争 0**(而站内兵家有 7 部,一本可对读的都没有)。

### 簇 A · 文学(补最薄的一块)
| 书 | 作者 | 接住什么 |
|---|---|---|
| 卡拉马佐夫兄弟 | 陀思妥耶夫斯基 | 「上帝已死之后怎么办」的小说版,接站内尼采五本 +《西西弗神话》;宗教大法官一章又接《理想国》《正义论》 |
| 局外人 | 加缪 | 与已有的《西西弗神话》**同一作者、一体两面**——那本讲理,这本演给你看 |
| 呐喊 | 鲁迅 | 中国现代文学 0 本;且与站内儒家诸书构成真张力:「礼教吃人」这句话是从哪来的 |
| 变形记 | 卡夫卡 | 接《规训与惩罚》《1984》——三种「人被制度处理掉」 |

### 簇 B · 科学
| 书 | 作者 | 接住什么 |
|---|---|---|
| 物种起源 | 达尔文 | 站内有《自私的基因》却没有源头。⚠️ **须点破社会达尔文主义是误用** |
| 复杂 | 梅拉妮·米歇尔 | 接《黑天鹅》《反脆弱》——那两本讲不确定性,这本讲它从哪来 |
| 数学之美 | 吴军 | 数学 0 本、技术 0 本,一石二鸟且好读 |

### 簇 C · 历史
| 书 | 作者 | 接住什么 |
|---|---|---|
| 旧制度与大革命 | 托克维尔 | **同作者的《论美国的民主》站内已有**,两本合起来才是完整的托克维尔。⚠️ 中文语境下曾被高度政治化解读,**只谈书、不作现实影射** |
| 大分流 | 彭慕兰 | 接《国家为什么会失败》《枪炮、病菌与钢铁》。⚠️ 学界有真争论(彭慕兰 ↔ 黄宗智),**并陈不裁断** |
| 叫魂 | 孔飞力 | 接《万历十五年》;乾隆朝一场妖术恐慌如何暴露官僚制,小切口大问题 |

### 簇 D · 整块空白
| 书 | 作者 | 接住什么 |
|---|---|---|
| 第二性 | 波伏娃 | **性别完全空白**,而站内《菊与刀》《洁净与危险》正是同路的文化研究。⚠️ 交代成书语境与后来的批评,**不作当下立场宣示** |
| 战争论 | 克劳塞维茨 | 站内兵家 7 部却无一本可对读的西方兵学。「战争是政治的延续」↔ 孙子「兵者国之大事」是现成一组 |
| 技术的本质 | 布莱恩·阿瑟 | 技术思想史 0 本;接《枪炮、病菌与钢铁》——那本讲技术塑造历史,这本讲技术自己怎么长出来 |
| 瓦尔登湖 | 梭罗 | 环境仅 1 本;与《第二座山》《活出生命的意义》是同一问题的三种答法 |

**四本要批判性框注**(达尔文的误用 / 托克维尔的政治化解读 / 大分流的学界争论 / 第二性的语境)
—— SOP 本有此规矩,先标出来免得开工才想起。

**作业标准**:[books-production-standard.md](./books-production-standard.md)(十步清单 + 版权红线:
原书全文绝不入库、文章原创消化非全文复制、引文 ≤100 字/条且 ≤16 条/篇)。
**开工前先查 `src/data/books/index.json`**,别信任何书单(含本表)。

## 2.3 争鸣 · 续扩(素材已备,随时可开)

现 **84 辩**,roadmap 候选已全部验完做完、`planned` 清零。**下轮现成素材**(做「勇」时候选过多、
主动舍下,均已 grep 坐实):孙子`勇怯，势也`(兵势 ch5)+ 墨子`勇，志之所以敢也`(经上 ch32)
→ 可另开一辩「**勇是性情还是形势**」(把勇从德性问题挪到形势问题,是不同的问法)。

**选题铁律**(owner 明确纠正过):只问「同一个点上各家是否真有交锋、或真有共鸣」;
**家次分布/覆盖均衡不是选题依据**。方法(概念索引法)与已否决清单见
[debates-roadmap.md](./debates-roadmap.md)。

**新加辩题的流程**:写 `src/data/debates/<id>.json` → `node scripts/sync-debate-index.mjs --write`
→ `npm run check-data`。**新辩要一并写「白话讲解 + 逐句 gloss」**(check-data 已加校验)。
...
- **长短经「七雄略 / 三国权」两篇** ◆ —— 整卷即一篇(46820 字),内部无任何标记、无法自动切。
  三条路:(a) 维持卷级一篇概览(现状)(b) **人工按史事分段**(苏秦合纵 / 张仪连横 / 三国鼎立…),
  走既有的 `texts.json` `pieces` 机制,与传习录同一套,不必发明新东西 (c) 机械按段区间切(会切断叙事,不推荐)。
  **倾向 (b)**,已在做。
