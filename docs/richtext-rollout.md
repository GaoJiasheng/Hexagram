...
**截至最后更新**:白话 1012 章(已做 74,均在 dao/daodejing)、观书 1034 篇(未开始)。总盘子 **2046 篇**。
...
**全部完成:2046 篇 · 3093 新块 · 0 失败。** 复跑一次即知现状(§0)。

### ⚠ 核对口径(别被数字吓到)
「有新块的篇数」≠「已处理的篇数」。**全部 2046 篇都跑过脚本**;其中约 93% 产出了新块,
...
_最后更新:2026-07-27。当时的 2046 篇已全量处理;此后仓库又新增诗经 79 首白话与 14 本观书,
经核验 **79/79、112/112 都自带富文本** —— §5 的「新文章模板止血」确实生效,不再产生欠账。
现总量约 1006 章白话 + 1034 篇观书。计数一律以 §0 脚本为准。_
